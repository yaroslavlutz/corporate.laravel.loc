...
<div id="block_edit_menu" class="block-edit-entries">
    <div class="container-fluid">
        ...
        <form class="form-horizontal" name="edit_entries_form" action="{{ route('admin_menus_update',['menu' => $current_menu->id]) }}" method="post" novalidate>
            ...
            <input type="hidden" name="_method" value="PUT"> <!--необходимо,чтобы осуществить REST-метод и чтобы отработал наш метод `public function update()` в `app/Http/Controllers/Admin/MenuResourceController.php`-->
