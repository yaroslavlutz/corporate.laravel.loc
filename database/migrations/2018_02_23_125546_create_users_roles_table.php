...
class CreateUsersRolesTable extends Migration
{
    ...
    */
    ...
    {  /* Связующая таблица, по внешнему_ключу, между таблицами `users` и `roles` */
        Schema::create('users_roles', function (Blueprint $table) { //Можно сразу к создаваемым ячейкам применять какие-то default-значения: $table->text('text')->default('some text..');
