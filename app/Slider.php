...
class Slider extends Model
{
    ...
    */
    ...
    protected $guarded = [
        //'id', 'title', 'desctext', 'images', 'created_at', 'updated_at'
    ];
    ...
    */
    public static function get_entries( $select=FALSE, $pagination=FALSE, $relationload=FALSE, $where=array() ) {
        ...
        if( !$pagination ) {  //Если пагинация не нужна
            ...
            else { $result_entries = self::select( $select )->get();  }  //Slider::get( $select );
        ...
        //$result_slides = Slider::get( array('id', 'title', 'desctext', 'images') )->toArray(); //Portfolio::all()->toArray();
        //$result_slides = Slider::select('id', 'title', 'desctext', 'images')->get()->toArray();
    }
