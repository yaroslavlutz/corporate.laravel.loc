...
class Menu extends Model
{
    ...
    */
    ...
    protected $guarded = [
        //'id', 'parent_menu_id', 'title', 'url_path', 'created_at', 'updated_at'
    ];
    ...
    */
    public static function get_all_menu() {
        $result_menu = self::get( array('id', 'parent_menu_id', 'title', 'url_path') )->toArray(); //Menu::all()->toArray();
        //$result_menu = Menu::select('id', 'parent_menu_id', 'title', 'url_path')->get()->toArray();
        return $result_menu;
    }
